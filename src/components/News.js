...
export default class News extends Component {
  ...
  //     description:
  //       "Former Notre Dame basketball coach and NCAA champion Muffet McGraw joins CNN's Chris Wallace to discuss players getting paid to play college sports.",
  ...
  //     urlToImage:
  //       "https://media.cnn.com/api/v1/images/stellar/prod/230314223544-ncaa-muffet-mcgraw-vpx.jpg?c=16x9&q=w_800,c_fill",
  ...
  //     description:
  //       "Diamond Sports Group, the Sinclair subsidiary that controls the RSNs for more than 40 teams across MLB, the NHL and the NBA, has filed for bankruptcy.",
  //     url: "http://espn.go.com/mlb/story/_/id/35860875/diamond-owner-rsns-40-plus-teams-files-bankruptcy",
  //     urlToImage:
  //       "https://a3.espncdn.com/combiner/i?img=%2Fphoto%2F2023%2F0315%2Fr1144652_1024x576_16%2D9.jpg",
  //     publishedAt: "2023-03-15T00:55:00Z",
  //     content:
  //       "Diamond Sports Group, the Sinclair subsidiary that controls the regional sports networks for more than 40 teams across Major League Baseball, the National Hockey League and the National Basketball As… [+3375 chars]",
  //   },
  //   {
  //     source: {
  //       id: "axios",
  ...
  //     urlToImage:
  //       "https://images.axios.com/3P_BBtS8TVmQYwAL9SCtN5R7s-8=/0x0:0x0/1366x768/2023/03/11/1678563800574.jpg",
  ...
  //     description:
  //       "Retrouvez l'essentiel de l'actualité sportive avec votre flash L'Équipe quotidien.",
  //     url: "https://www.lequipe.fr/Tous-sports/Actualites/Le-flash-sports-du-15-mars/1385909",
  //     urlToImage:
  //       "https://medias.lequipe.fr/img-photo-jpg/le-flash-sports-du-15-mars-l-equipe/1500000001760157/0:0,1995:1330-640-427-75/25774.jpg",
  //     publishedAt: "2023-03-14T23:12:00+00:00",
  //     content:
  //       "Grâce à un historique Erling Haaland, Manchester City s'est qualifié pour les quarts de finale de la Ligue des champions. Ce mercredi soir, le Real Madrid de Karim Benzema doit finir le travail contr… [+123 chars]",
  //   },
  //   {
  //     source: {
  //       id: "les-echos",
  ...
  //     author: "Les Echos",
  //     title:
  //       "Retraites : les prévisions de trafic dans les transports ce mercredi",
  //     description:
  //       "La circulation sera plus fluide dans le métro parisien que dans les trains et les RER. Les perturbations en détail.",
  ...
  //     urlToImage:
  //       "https://media.lesechos.com/api/v1/images/view/6410a3e7047c524ff1388129/1280x720/0703560674058-web-tete.jpg",
  //     publishedAt: "2023-03-14T16:40:55Z",
  //     content:
  //       "Le mouvement de grève contre la réforme des retraites se poursuit avec une huitième journée de mobilisation prévue ce mercredi. Dans des prévisions publiées ce mardi, la RATP annonce « un trafic quas… [+2519 chars]",
  //   },
  //   {
  //     source: {
  //       id: "time",
  ...
  //     description:
  //       "After an investigation, Gregg Berhalter remains under consideration to coach the men's team at the 2026 World Cup, but U.S. Soccer still finds itself in a difficult spot.",
  //     url: "http://time.com/6262577/us-soccer-claudio-reyna-gio-berhalter/",
  //     urlToImage:
  //       "https://api.time.com/wp-content/uploads/2023/03/Claudio-Reyna.jpg?quality=85&w=1200&h=628&crop=1",
  //     publishedAt: "2023-03-14T06:00:07Z",
  //     content:
  //       "Any casual follower of the U.S. men’s national soccer team could suss out that an investigation into the ugly feud brewing between World Cup coach Gregg Berhalter and parents of player Gio Reyna was … [+8521 chars]",
  //   },
  //   {
  //     source: {
  //       id: "le-monde",
  ...
  //     title:
  //       "Vidéo. « Personne n’a écouté nos plaintes » : la colère gronde en Grèce après la collision mortelle de deux trains",
  //     description:
  //       "Vidéo - Les manifestations se multiplient en Grèce, une semaine après la collision de deux trains qui a causé la mort de cinquante-sept passagers. La population se plaint de l’insalubrité du service de transports publics, qui semble être de notoriété publique…",
  ...
  //     urlToImage:
  //       "https://img.lemde.fr/2023/03/05/0/1/3118/2079/1440/960/60/0/f8726a3_119ae6cc1dbe47aab498577ef2113322-0-31a6eb484d694697b2455f3ba594ab87.jpg",
  //     publishedAt: "2023-03-09T15:15:04Z",
  //     content:
  //       "« Nous, les conducteurs, avons déposé des plaintes à ce sujet, nous avons fait grève à ce sujet, () mais malheureusement personne na écouté », regrette Kostas Genidounias, leader grec du syndicat des… [+852 chars]",
  //   },
  //   {
  //     source: {
  //       id: "bleacher-report",
  ...
  async componentDidMount() {
    let url = `https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=db8f74328e11444e920e42ff01a4c00f&page=1&pageSize=15`;
  ...
  handleNextClick = async () => {
    ...
    if (this.state.page + 1 <= Math.ceil(this.state.totalResults / 15)) {
      let url = `https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=db8f74328e11444e920e42ff01a4c00f&page=${
        this.state.page + 1
      }&pageSize=15`;
      let data = await fetch(url);
      let parsedData = await data.json();
  ...
  render() {
    ...
    return (
      <div className="container my-3">
        <h1 className="text-center">NewsMonk - Bulletine</h1>
